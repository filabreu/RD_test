  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created query as @query" do
        ...
        expect(assigns(:query)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved query as @query" do
        post :create, {:query => invalid_attributes}, valid_session
        expect(assigns(:query)).to be_a_new(Query)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested query" do
        query = Query.create! valid_attributes
        put :update, {:id => query.to_param, :query => new_attributes}, valid_session
        query.reload
    ...
    context "with invalid params" do
      it "assigns the query as @query" do
        query = Query.create! valid_attributes
        put :update, {:id => query.to_param, :query => invalid_attributes}, valid_session
        expect(assigns(:query)).to eq(query)
      end
